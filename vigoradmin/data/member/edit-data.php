<?php
$SQL=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tmember WHERE kdMember='$_GET[id]'");
        ...
        <div class='widget-content nopadding'>
		  ...
		  <input type='hidden' name='id' value='$_data[kdMember]'>
            ...
            <div class='control-group'>
              ...
              <div class='controls'>
                <input type='email' class='span6' placeholder='example@ex.com' name='txtEmail' value='$_data[emailMember]' />
              </div>
            </div>
            <div class='control-group'>
