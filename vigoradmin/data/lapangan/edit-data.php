<?php
$SQL=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tlapangan WHERE kdLapangan='$_GET[id]'");
        ...
        <div class='widget-content nopadding'>
		  ...
		  <input type='hidden' name='id' value='$_data[kdLapangan]'>
            <div class='control-group'>
              ...
              <div class='controls'>
                <input type='text' class='span2' placeholder='Nomor Lapangan' name='txtNoLapangan' value='$_data[noLapangan]' />
              </div>
            </div>
			<div class='control-group'>
              ...
              <div class='controls'>
				...
				if(isset($_data['gambarLapangan'])){
					echo"<img src='../gambar/lapangan_img/small/small_$_data[gambarLapangan]'>";
           ...
           <div class='control-group'>
              ...
              <div class='controls'>
                 <textarea name='txtDeskripsi' class='textarea_editor span12' rows='12' placeholder='Enter text ...'>$_data[deskripsi]</textarea>
              </div>
            </div>
