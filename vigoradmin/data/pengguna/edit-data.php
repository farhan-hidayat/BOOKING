<?php
$SQL=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tpengguna WHERE kdPengguna='$_GET[id]'");
        ...
        <div class='widget-content nopadding'>
		  ...
		  <input type='hidden' name='id' value='$_data[kdPengguna]'>
            <div class='control-group'>
              ...
              <div class='controls'>
                <input type='text' class='span6' placeholder='username' name='txtUsername' value='$_data[username]' />
              </div>
            </div>
            <div class='control-group'>
            ...
            <div class='control-group'>
              ...
              <div class='controls'>
                <input type='text' class='span6' placeholder='Nama Lengkap' name='txtNmLengkap' value='$_data[nmPengguna]' />
              </div>
            </div>
			<div class='control-group'>
            ...
            <div class='control-group'>
              ...
              <div class='controls'>
                <input type='text' class='span12' placeholder='Jl.Example' name='txtAlamat' value='$_data[alamatPengguna]' />
              </div>
            </div>
            <div class='control-group'>
              <label class='control-label'>Email pengguna:</label>
              <div class='controls'>
                <input type='email' class='span6' placeholder='example@ex.com' name='txtEmail' value='$_data[emailPengguna]' />
              </div>
            </div>
            <div class='control-group'>
