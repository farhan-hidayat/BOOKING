        ...
        <div class="widget-box">
          ...
          <div class="widget-content">
            <div class="row-fluid">
              ...
              <div class="span6">
                <table class="table table-bordered table-invoice">
                  <tbody>
                    ...
                    <tr>
                    <?php
					$query=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT MAX (noOrder) As nomorOrder FROM tboking");
              ...
              <div class="modal-header">
                ...
                <h3>DAFTAR JADWAL LAPANGAN FUTSAL VIGOR PONTIANAK</h3>
              </div>
          ...
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
               <?php
			   $SQL=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tjadwal,tlapangan,tjam WHERE 
              ...
              <div class="span12">
                <table class="table table-bordered table-invoice-full">
                 ...
                 <th>Aksi</th>
                  ...
                  <tbody>
                    <?php
			   $SQL=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tboking_temp WHERE idSession='$_SESSION[username]'");
			   $no=1;
			   if($no % 2==1){
					   $class="gradeU";
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="right"><strong>Total Bayar</strong> <br>
                        ...
                        <?php
						$to=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT SUM(subTotalTemp) AS subtotal FROM tboking_temp WHERE idSession='$_SESSION[username]'");
						$r=mysqli_fetch_array($to);
						$total=$r['subtotal'];
						$totalRp=idr_f($total);
						echo"
