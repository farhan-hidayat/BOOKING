...
$SQL=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tboking WHERE kdBoking='$_POST[id]'");

$_data=mysqli_fetch_array($SQL) or die (mysqli_error($GLOBALS["___mysqli_ston"]));
          ...
          <div class='widget-content'>
            ...
            <div class='row-fluid'>
              <div class='span12'>
			   ...
			   $SQL=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM trincian_boking WHERE kdBoking='$_data[kdBoking]'");
			   $no=1;
			   if($no % 2==1){
					   $class='gradeU';
