                       ...
                       <table class="table">
							...
							echo"<label class='label label-danger'><h5><font color='#FFFFFF'>INVOICE : <strong># $newID </font></strong></h5></label>";
								  ?>
                                    ...
                                    <?php
						$boking=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM tboking_temp WHERE idSession='$_SESSION[username]'");
						$no=1;
						while($_data=mysqli_fetch_array($boking)){
							...
							";
                                    ...
                                    <tr>
                                      ...
                                      <?php
									  $Total = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT SUM(subTotalTemp) AS subtotal FROM tboking_temp WHERE idSession='$_SESSION[username]'");
